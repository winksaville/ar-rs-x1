# Investigate Karpthapy autoresearch (ar-ai) technique

How does Karpathy's autoresearch technique work and
inparticular can I create a rust version of it?

This is the main repo of a dual-repo convention for using
a bot to help in the development of a coding project.

I will be using `jj-git` to manage the repo, but this
feel free to use git if you prefer.

I'm going to try using git submodules to manage the .claude/ bot repo
as well as the autoreaserch/ repo and autoresearch-rs/ repo.
